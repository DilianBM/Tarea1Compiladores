...
gg VARCHAR (255) ,
 yyyy_id BOOLEAN ,  FOREIGN KEY (yyyy_id) REFERENCES A(basura) ,
 assS_id BOOLEAN ,  FOREIGN KEY (assS_id) REFERENCES A(basura) ,
objeto BOOLEAN ,
valor VARCHAR (255) ,
 awss_id  VARCHAR (255)  ,  FOREIGN KEY (awss_id) REFERENCES NOMBREDETABLA2(llave) ,
 a2_id  VARCHAR (255)  ,  FOREIGN KEY (a2_id) REFERENCES NOMBREDETABLA2(llave) 
);
CREATE TABLE G ( 
